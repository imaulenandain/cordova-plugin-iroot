...
public class Utils {
    ...
    public static String getSystemProperty(String key) {
        ...
        try {
            ...
            LOG.e(Constants.LOG_TAG, "[getSystemProperty] Class not found: " + e.getMessage());
        } catch (NoSuchMethodException e) {
            LOG.e(Constants.LOG_TAG, "[getSystemProperty] Method not found: " + e.getMessage());
        } catch (Exception e) {
            LOG.e(Constants.LOG_TAG, "[getSystemProperty] Error: " + e.getMessage());
        }
        return value;
    }
}
